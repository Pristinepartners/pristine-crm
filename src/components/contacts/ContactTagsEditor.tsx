      ...
      <div className="flex flex-wrap gap-2">
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-sm border border-dashed border-[var(--color-border-strong)] text-[var(--color-text-secondary)] hover:border-[var(--color-text-muted)] hover:text-[var(--color-text-secondary)] transition disabled:opacity-50"
          >
          ...
          {showDropdown && availableTags.length > 0 && (
            <div className="absolute top-full left-0 mt-1 w-48 bg-white rounded-lg shadow-lg border border-[var(--color-border)] py-1 z-10 max-h-48 overflow-y-auto">
